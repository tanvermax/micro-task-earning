...
const Section2 = () => {
  ...
  return (
    <div>
      ...
      <div className="grid lg:grid-cols-3 grid-cols-2 gap-5  lg:gap-10 px-5">
        {wokerdata.map((item) => (
          <div key={item._id} className="max-w-2xl mx-0 sm:max-w-sm md:max-w-sm lg:max-w-sm xl:max-w-sm sm:mx-auto md:mx-auto lg:mx-auto xl:mx-auto lg:mt-16 bg-white shadow-xl rounded-lg text-gray-900">
            ...
            <ul className="lg:py-4 mt-2 text-gray-700 flex items-center justify-around">
