...
const Section5 = () => {
    return (
        ...
        <div className="bg-[#ddbd9d] text-white rounded-lg p-8 shadow-lg">
          ...
          <button className="bg-white text-[#a87541] font-semibold px-6 py-2 rounded hover:bg-red-500 hover:text-white transition">
            Find A Job
          </button>
        </div>
        ...
        <div className="bg-white text-gray-900 rounded-lg p-8 shadow-lg">
          ...
          <button className="bg-[#ddbd9d] text-white font-semibold px-6 py-2 rounded hover:bg-red-700 transition">
            Post A Job
          </button>
        </div>
      </div>
