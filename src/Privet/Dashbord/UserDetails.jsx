    ...
    <>
      ...
      <section className="">
        <div className="w-full  lg:max-w-7xl mx-auto">
          <div className="flex items-center  sm:justify-start relative z-10 lg:mb-5">
            <img
              src={userData.photo}
          ...
          <div className="grid grid-cols-2 px-1 lg:flex flex-col sm:flex-row max-sm:gap-5 items-center lg:justify-between mb-5">
            <div className="block">
            ...
            <button className=" rounded-full lg:py-3 px-5 bg-gray-100 flex items-center group transition-all duration-500 hover:bg-indigo-100 mr-10 md:w-[120px] ">
              <svg
