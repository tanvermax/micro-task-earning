...
//  console.log(userData);
  ...
  return (
    <div className="max-w-3xl mx-auto p-6  rounded-lg shadow-lg">
      <h1 className="text-3xl font-semibold text-center  mb-6">Withdraw Your Earnings</h1>
      
      <div className=" p-6 rounded-lg shadow-md mb-8">
        <p className="lg:text-lg text-[8px] "><strong>Total Coins:</strong> {totalCoins}</p>
        <p className="lg:text-lg text-[8px] "><strong>Withdrawal Amount:</strong> ${withdrawableAmount}</p>
      </div>

      <form className="space-y-6">
        <div className="flex flex-col space-y-2">
          <label className="lg:text-lg text-[8px] ">Coins to Withdraw:</label>
          <input
            type="number"
            className="p-3 lg:text-lg text-[8px] rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500"
        ...
        <div className="flex flex-col space-y-2">
          <label className="lg:text-lg text-[8px] ">Withdrawal Amount ($):</label>
          <input
            type="number"
            className="p-3 lg:text-lg text-[8px] rounded-md border border-gray-300  cursor-not-allowed"
        ...
        <div className="flex flex-col space-y-2">
          <label className="lg:text-lg text-[8px] ">Select Payment System:</label>
          <select
            className="p-3 lg:text-lg text-[8px] rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500"
            value={paymentSystem}
        ...
        <div className="flex flex-col space-y-2">
          <label className="lg:text-lg text-[8px] ">Account Number:</label>
          <input
            type="text"
